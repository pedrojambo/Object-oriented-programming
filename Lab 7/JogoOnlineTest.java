...
//        }
    ...
    @Test (expected = UsuarioInexistenteException.class)
    public void testarUsuarioInexistente() throws UsuarioInexistenteException, SenhaInvalidaException {
        Jogador jogadorJoao = jogo.cadastrarJogador("joao", "1234");
        jogo.fazerLogin("joaoo","1234");
        assertFalse(jogadorJoao.isOnline());
    }

    @Test (expected = SenhaInvalidaException.class)
    public void testarSenhaInvalida() throws UsuarioInexistenteException, SenhaInvalidaException {
        Jogador jogadorJoao = jogo.cadastrarJogador("joao", "1234");
        jogo.fazerLogin("joao","12345");
        assertFalse(jogadorJoao.isOnline());
    }
}