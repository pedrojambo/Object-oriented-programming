...
public class ContaTest {
    ...
    public void testarAplicarJuros(){
        ContaInvestimento InvestimentoJoao = new ContaInvestimento(3, joao, "moeda", 1.50f);
        ContaInvestimento InvestimentoMaria = new ContaInvestimento(4, maria, "moeda", 1.30f);
        InvestimentoJoao.receberDepositoEmDinheiro(9990);
        InvestimentoMaria.receberDepositoEmDinheiro(990);
        InvestimentoJoao.aplicarJuros();
        InvestimentoMaria.aplicarJuros();
        assertEquals(15000, InvestimentoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals(1300, InvestimentoMaria.getSaldoEmReais(), FLOAT_DELTA);
    }
    ...
    public void testarResgatarTotal(){
        ...
        InvestimentoJoao.aplicarJuros();
        InvestimentoMaria.aplicarJuros();
        InvestimentoJoao.resgatarTotal(contaDoJoao);
        InvestimentoMaria.resgatarTotal(contaDaMaria);
        assertEquals(15010, contaDoJoao.getSaldoEmReais(), FLOAT_DELTA);
        assertEquals(1310, contaDaMaria.getSaldoEmReais(), FLOAT_DELTA);
    }
